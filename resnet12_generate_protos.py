...
class ResNet12(nn.Module):
    def __init__(self, feature_maps, input_shape, num_classes, few_shot, rotations):
        ...
        self.linear_att = linear(300, 10 * feature_maps)
    ...
    def forward(self, x, batch_word_embedding=None, index_mixup = None, lam = -1, minus_channel=False):
        if lam != -1:
