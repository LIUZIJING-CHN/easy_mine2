...
# --memorybank-path /data/lzj/easy/save_features/save_memorybank_res12/res12frozen_5x5/memorybank_1.pkl \
# --save-features /data/lzj/easy/save_features/0904/res12only_attri/minifeaturesAS_attri_15switch2_1.pt \
# --n-shots 1 \
# --batch-size 128 \
# --sample-aug 30 \
# --preprocessing ME
...
--test-features "/data/lzj/easy/save_features/0904/res12only_attri/minifeaturesAS_attri_15switch2_1.pt1,/data/lzj/easy/save_features/0904/res12only_attri/minifeaturesAS_attri_15switch2_2.pt1,/data/lzj/easy/save_features/0904/res12only_attri/minifeaturesAS_attri_15switch2_3.pt1" \
--preprocessing ME \
--n-shots 1 \
--batch-fs 1
