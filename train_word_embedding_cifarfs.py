...
data = torch.load('./word_embedding/cifarfs/train_vocab_vec.pkl')
target = torch.load('./save_tensor/raw_feat/1120/new_feature_cifarfs_base64_res12_0.5attriloss_0.3relationloss/save_protos_1shot.pkl')
test_data = torch.load('./word_embedding/cifarfs/test_vocab_vec.pkl')
# test_target = torch.load('/data/lzj/easy_mine/save_tensor/raw_feat/1120/feature_cifar_base64_word_embed_relation_res12/novel_save_protos.pkl')
...
save_path = './result_word_embedding_model/cifar-fs/new_feature_cifarfs_base64_res12_0.5attriloss_0.3relationloss_1shot.pkl'
...
torch.save(out, './word_embedding/cifarfs/0.5attriloss_0.3relationloss_generate_novel_protos_1shot_relation.pkl')
