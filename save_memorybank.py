import torch
import resnet12, resnet12_generate_protos, resnet12_ori
import numpy as np
...
# flag = 0
# element_per_class = elements_per_class[0]
# print(elements_per_class)
# for i in range(len(element_per_class)):
#     class_num = element_per_class[i]
#     class_proto = save_feature[flag : flag+class_num].mean(dim=0, keepdim=True)
#     save_protos.append(class_proto)
#     flag += class_num
...
# torch.save(save_protos, '/data1/lzj/easy_mine/save_tensor/raw_feat/1120/feature_mini_base64_res12_absolute_only/save_protos_1shot.pkl')
save_path = args.save_memorybank_path
if not os.path.exists(save_path):
    os.makedirs(save_path)
torch.save(save_protos, os.path.join(save_path, 'save_protos_1shot.pkl'))
