...
--memorybank-path /data/lzj/easy/save_features/save_memorybank/res12frozen_attri_mse/memorybank_1.pkl \
--save-features /data/lzj/easy/save_features/0912/res12only_attri_stage/feature_test.pt \
--n-shots 1 \
--batch-size 128 \
--sample-aug 1 \
--preprocessing ME
...
# --model resnet12 \
# --load-attri-model /data/lzj/easy/result/0908/res12frozen_attri_cos/attri_model_1.pt1 \
# --test-features "/data/lzj/easy/save_features/0908/res12frozen_attri_cos/minifeaturesAS_attri_15switch1_1.pt1," \
# --preprocessing ME \
# --n-shots 1
