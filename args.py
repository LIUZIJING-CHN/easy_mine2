...
parser.add_argument("--seed", type=int, default=10, help="set random seed manually, and also use deterministic approach")
...
####自己加的args####
parser.add_argument("--load-attri-model", type=str, default="", help="load attribute generator checkpoint")
parser.add_argument("--memorybank-path", type=str, default="", help="load memory bank")
parser.add_argument("--class-relation", type=str, default="", help="class relation")
parser.add_argument("--save-attri-model", type=str, default="", help="save model to file")
parser.add_argument("--use-supp", action="store_true", help="use embedding support")
parser.add_argument("--feat-topk", action="store_true", help="use topk feat")
parser.add_argument("--topk", type = int, default=500, help="the number of topk samples")
parser.add_argument("--no-train", action="store_true", help="val and test to load weight")
parser.add_argument("--attriloss_weight", type = float, default=0.5, help="weight_of_attriloss")
parser.add_argument("--relationloss_weight", type = float, default=0.5, help="weight_of_relationloss")
parser.add_argument("--attri-bank", type=str, default="", help="path to the word embedding vector bank")
parser.add_argument("--class-relations", type=str, default="", help="path to the class correlation of word embedding")
parser.add_argument("--save-memorybank-path", type=str, default="", help="path to save memorybank")
